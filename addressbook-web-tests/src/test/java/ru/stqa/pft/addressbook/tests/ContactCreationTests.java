...
public class ContactCreationTests {
    ...
    public void testContactCreation() {
        initContactCreation();
        fillContactForm(new ContactData("first name", "middle name", "last name", "nich name", "title", "company", "", "", "", "", "", "email", "email2", "email3", "homePage", "secondaryAddress", "phone2", "notes"));
    ...
    private void fillContactForm(ContactData contactData) {
        ...
        if (!wd.findElement(By.xpath("//div[@id='content']/form/select[4]//option[9]")).isSelected()) {
